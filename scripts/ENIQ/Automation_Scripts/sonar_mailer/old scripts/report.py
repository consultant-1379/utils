...
#platform =['sonarqube-scanner-helpset_stats']
...
netan_platform = ['ENIQ_network-analytics-utilities','ENIQ_network_analytics_server','sonarqube-scanner-information_store_parser','sonarqube-scanner-kpiparser']

ocs = ['Eniq_BO_OCS']

bo = ['Eniq_BO_EBID','Eniq_BO_WINDOWS_AUTOMATION']
