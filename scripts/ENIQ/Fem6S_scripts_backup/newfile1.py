...
list2 = out2.split('\n')
print(list2[0])
os.system("sshpass -p Naples!0512 scp /home/eniqdmt/gagan/ENIQ_Feature_Files_Linux/" + list2[0] + " esjkadm100@fem6s11-eiffel013.eiffel.gic.ericsson.se:/proj/eiffel013_config_fem6s11/eiffel_home/slaves/ComputeFarm1/workspace/")
...
#os.system('sshpass -p shroot12 scp -P 2251 -o StrictHostKeyChecking=no /home/eniqdmt/gagan/'+list2[0]+' root@'+sys.argv[2]+'.athtem.eei.ericsson.se:/eniq/home/dcuser')
