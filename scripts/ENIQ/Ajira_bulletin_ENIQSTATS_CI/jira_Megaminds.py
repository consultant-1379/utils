...
config.read('scripts/etc/config_jira_Megaminds.cfg')
...
#start writing html
emailHeader = open("scripts/etc/mailHeader_jira_Megaminds.txt", 'r')
emailReport = open("scripts/etc/mailReport_jira_Megaminds.html", 'w')
