...
config.read('scripts/etc/config_jira_FireBalls.cfg')
...
#start writing html
emailHeader = open("scripts/etc/mailHeader_jira_FireBalls.txt", 'r')
emailReport = open("scripts/etc/mailReport_jira_FireBalls.html", 'w')
