...
my $PKG_LIST = "/proj/eiffel013_config_fem5s11/eiffel_home/FULL_PF_KGB_DATA/Pkg_List";
...
my $zip_full_paths = "/proj/eiffel013_config_fem5s11/eiffel_home/FULL_PF_KGB_DATA/Pkg_List/";
