...
#                   * Convert them into Ericsson standard HOT EC delivery format    *
#                   * Generate HTML file               				    			*
# ***********************************************************************************
#import sys
...
if len(pro)==1:
        ...
        for num in pro:
                if pro.index(num) == 0:
                        ...
                        strTable = strTable+strRW
strRW = "<tr style='height: 25px'><td>Requester:</td><td>&nbsp;&nbsp;&nbsp;</td><td>"+request+"</td></tr><tr style='height: 25px'><td>Reason:</td><td>&nbsp;&nbsp;&nbsp;</td><td>Correction of JIRA "+reason+"</td></tr><tr style='height: 25px'><td>Deployment:</td><td>&nbsp;&nbsp;&nbsp;</td><td>"+deploy+"</td></tr></table><ol type='1'><li>Download Information:</li>";
strTable = strTable+strRW
gask = gasks.split("$")
for num in pro:
        x = num.split("_R", 1)
