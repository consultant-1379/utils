...
my $PF_KGB_DATA_DIR = ${JENKINS_HOME}."/ALL_PF_KGB_DATA/";
my $PKG_LIST = "/proj/eiffel013_config_fem5s11/eiffel_home/ALL_PF_KGB_DATA/Pkg_List";
...
my @all_zip=`ls $PKG_LIST | grep zip`;
my $zip_full_paths = "/proj/eiffel013_config_fem5s11/eiffel_home/ALL_PF_KGB_DATA/Pkg_List/";
...
sub Copy_PLATFORM
{
        ...
        foreach (@pf_pkgs_checked_in)
        {
                        ...
                        #$platform_value =~ s/ //g;
                        print " The platform_value is $platform_val \n";
                        ...
                        `cp -rf $plat_full_path $CHECK_IN_FILES`;
        } # for closed
