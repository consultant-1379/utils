...
jqlQuery='jql=project%20%3D%20CIS%20AND%20component%20%3D%20%22CI%20Infra%20%2F%20CI%20Fwk%22%20AND%20%22Your%20PDG%2FArea%22%20%3D%20%22ENIQ%20Stats%22%20AND%20%22CI%20Support%22%20%3D%201%20AND%20%22CI%20Sub-Area%22%20%3D%20Infra%20AND%20status%20not%20in%20(Closed%2C%20Resolved)'
headers = {'Content-Type': 'application/json'}
getData=requests.get(str(jiraUrl)+str(jqlQuery) ,auth=HTTPBasicAuth('statsjenki','January@2019'),headers=headers,proxies=proxy)
