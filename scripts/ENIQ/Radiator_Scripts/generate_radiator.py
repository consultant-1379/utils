...
vapp_server = server_name("https://fem7s11-eiffel013.eiffel.gic.ericsson.se:8443/jenkins/view/vApp_II_Pipeline/job/ES_CDB_Vapp_II_Infra/") if vapp_status !=-1 else ""
vapp_tc = server_tc("https://fem7s11-eiffel013.eiffel.gic.ericsson.se:8443/jenkins/view/vApp_II_Pipeline/job/ES_CDB_Vapp_II_TC/") if vapp_status !=-1 else ""
print ("vapp_server:", vapp_server)
print ("vapp_tc:",vapp_tc)
print ("vapp status:", vapp_status)
