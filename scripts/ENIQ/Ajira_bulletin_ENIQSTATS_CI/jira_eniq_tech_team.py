...
config.read('scripts/etc/config_jira_eniq_tech_team.cfg')
...
#start writing html
emailHeader = open("scripts/etc/mailHeader_jira_eniq_tech_team.txt", 'r')
emailReport = open("scripts/etc/mailReport_jira_eniq_tech_team.html", 'w')
...
for data in jsonData['issues']:
		...
		if (ticketDays > 21 and ticketDays <= 28 ):
