...
path = "/net/10.45.192.134/JUMP/ENIQ_STATS/ENIQ_STATS/" + shipment + "/eniq_base_sw/eniq_sw/"
kgbPath = "/tmp/PF_KGB/"
tafParserFile = "/eniq/home/dcuser/latest_packages.txt"

if not os.path.exists(kgbPath):
	os.makedirs("/tmp/PF_KGB/")
...
print "\n\n"
print "="*30
print "PF KGB Packages available in /tmp/PF_KGB/ folder"
print ", ".join(kgb_pkgs)
print "="*30
print "\n\n"
