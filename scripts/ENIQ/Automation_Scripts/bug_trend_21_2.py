...
pf_bugs ='/html/body/div[2]/div/div/div[1]/div[4]/div/div[1]/div/div[2]/div/div[3]/div[3]/div[2]/div/div[17]/span[1]'
tp_bugs = '/html/body/div[2]/div/div/div[1]/div[4]/div/div[1]/div/div[2]/div/div[3]/div[3]/div[2]/div/div[19]/span[1]'
infra_bugs = '/html/body/div[2]/div/div/div[1]/div[4]/div/div[1]/div/div[2]/div/div[3]/div[3]/div[2]/div/div[14]/span[1]'
security_bugs = '/html/body/div[2]/div/div/div[1]/div[4]/div/div[1]/div/div[2]/div/div[3]/div[3]/div[2]/div/div[18]/span[1]'
...
path = "H:/Downloads/"
bo_ocs_bugs = "/html/body/div[2]/div/div/div[1]/div[4]/div/div[1]/div/div[2]/div/div[3]/div[3]/div[2]/div/div[12]/span[1]"
nmi_bugs = "/html/body/div[2]/div/div/div[1]/div[4]/div/div[1]/div/div[2]/div/div[3]/div[3]/div[2]/div/div[16]/span[1]"
netan_bugs = "/html/body/div[2]/div/div/div[1]/div[4]/div/div[1]/div/div[2]/div/div[3]/div[3]/div[2]/div/div[15]/span[1]"
...
def copy_to_vobs(png_name):
	png_name = "\\"+png_name;
	command = "pscp.exe -pw Naples!0512 H:\WDP\Desktop"+png_name+" esjkadm100@fem7s11-eiffel013.eiffel.gic.ericsson.se:/proj/eiffel013_config_fem7s11/eiffel_home/slaves/ComputeFarm1/workspace/Bug_Tracker_Report_21.2"
	os.system(command)
...
user.click()
keyboard.press_and_release('z,m,u,d,s,h,u')
#keyboard.press_and_release('e,s,j,k,a,d,m,1,0,0')
sleep(3)
password = driver.find_element_by_xpath('//*[@id="container"]/div/div/div[3]/form/div/div[1]')
password.click()
keyboard.press_and_release('shift+s,h,u,b,h,shift+4,9,5,9,5,5')
#keyboard.press_and_release('shift+n,a,p,l,e,s,shift+1,0,5,1,2')
sleep(3)
