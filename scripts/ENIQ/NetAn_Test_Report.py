...
f.write('<tr><th>Feature</th><th>Rstate</th><th>No of Tests</th><th>Passed</th><th>Failed</th><th>Skipped</th></tr>')
f.write('<tr><td>'+module+'</td><td>'+rstate+'</td><td>'+Tests+'</td><td>'+Passed+'</td><td>'+Failed+'</td><td>'+Skipped+'</td></tr>')
