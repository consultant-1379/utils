...
os.system("cp -r /proj/eiffel013_config_arm1s11/eiffel_home/storage/releases/com/ericsson/eniq/stats/tp_plm/ENIQ_Feature_Files_Linux /proj/eiffel013_config_fem6s11/eiffel_home/slaves/ComputeFarm1/workspace")
