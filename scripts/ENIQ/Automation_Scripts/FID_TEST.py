		...
		for row in sheet:
			for cell in row:
				if cell.value == cxc:
					...
					if ch == 'R18A' or ch == 'R18B'or ch == 'R18C' or ch == 'R18D' or ch == 'R18E' or ch == 'R18F' or ch == 'R18G':
						sheet.cell(row= cell.row,column=4).value = ch[:-1]+chr(ord(ch[3])+1)
					else:
						sheet.cell(row=cell.row,column=4).value = 'R18A'
					...
					revision = sheet.cell(row= cell.row,column=5).value
                                        if revision == 'GK1' or revision == 'GK2' or revision == 'GK3' or revision == 'GK4' or revision == 'GK5' or revision == 'GK6':
                                                sheet.cell(row= cell.row,column=5).value = revision[:-1]+chr(ord(revision[2])+1)
                                        else:
                                                sheet.cell(row=cell.row,column=5).value = 'GK1'
