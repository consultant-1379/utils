...
skipped = []
pending = []
os.chdir('/proj/eiffel013_config_fem5s11/eiffel_home/jobs/NetAn_Cypress_Test/builds')
...
f = open('/proj/eiffel013_config_fem5s11/slaves/RHEL_ENIQ_STATS/netan/test_report.html','w')
