	...
	if (os.path.isdir("FD")):
		...
		for dir in list1:
			...
			try:
				...
				os.system("curl -v -u esjkadm100:Naples\!0512 --upload-file "+dir+" https://arm104-eiffel004.lmera.ericsson.se:8443/nexus/content/repositories/releases/com/ericsson/eniq/stats/tp/"+cap_name+"/"+etls+"/FD/"+rstate+"/"+y+"/"+pkgs)
			except Exception:
				print "Exception"
