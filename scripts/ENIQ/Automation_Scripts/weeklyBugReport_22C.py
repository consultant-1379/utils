...
f = open('/home/esjkadm100/zhshees/Weeklyreport_22C.html','w')
...
f.write("<br><table border=\"2\" style=\'width:200\' cellpadding=\"4\"><tr align=\"left\" style='background-color:#e0ff44;'><b><font style='font-family:arial;'><th>F Status</th><th>TP<font style='color:#e0ff44'>-</font></th><th>Platform</th><th>NetAn</th><th>Total<font style='color:#e0ff44'>/</font>MRs</th></font></b></tr>\n")

f.write("<tr align=\"left\"><font style='font-family:arial;'><td style='background-color:#93c1f6;'>New</td><td align=\"center\" width=\"30%\">"+str(new_tp)+"</td><td align=\"center\" width=\"20%\">"+str(new_pf)+"</td><td align=\"center\" width=\"20%\">"+str(new_net)+"</td><td align=\"center\" width=\"30%\">"+str(new)+"</td></tr></font></tr>\n")

f.write("<tr align=\"left\"><font style='font-family:arial;'><td style='background-color:#93c1f6;'>F0</td><td align=\"center\">"+str(F0_tp)+"</td><td align=\"center\">"+str(F0_pf)+"</td><td align=\"center\">"+str(F0_net)+"</td><td align=\"center\">"+str(F0)+"</td></font></tr>\n")

f.write("<tr align=\"left\"><font style='font-family:arial;'><td style='background-color:#93c1f6;'><div style='width: 150px;'>Ready<font style='color:#93c1f6'>/</font>for<font style='color:#93c1f6'>/</font>F1</div></td><td align=\"center\">"+str(Ready_tp)+"</td><td align=\"center\">"+str(Ready_pf)+"</td><td align=\"center\">"+str(Ready_net)+"</td><td align=\"center\">"+str(Ready)+"</td></font></tr>\n")

f.write("<tr align=\"left\"><font style='font-family:arial;'><td style='background-color:#93c1f6;'>F1</td><td align=\"center\">" +str(F1_tp)+ "</td><td align=\"center\">"+str(F1_pf)+"</td><td align=\"center\">"+str(F1_net)+"</td><td align=\"center\">"+str(F1)+"</td></font></tr>\n")

f.write("<tr align=\"left\"><font style='font-family:arial;'><td style='background-color:#93c1f6;'>F2</td><td align=\"center\">"+str(F2_tp)+"</td><td align=\"center\">"+str(F2_pf)+"</td><td align=\"center\">"+str(F2_net)+"</td><td align=\"center\">"+str(F2)+"</td></font></tr>\n")

f.write("<tr align=\"left\"><font style='font-family:arial;'><td style='background-color:#93c1f6;'>F3</td><td align=\"center\">"+str(F3_tp)+"</td><td align=\"center\">"+str(F3_pf)+"</td><td align=\"center\">"+str(F3_net)+"</td><td align=\"center\">"+str(F3)+"</td></font></tr>\n")

f.write("<tr align=\"left\"><font style='font-family:arial;'><td style='background-color:#93c1f6;'>F4</td><td align=\"center\">"+str(F4_tp)+"</td><td align=\"center\">"+str(F4_pf)+"</td><td align=\"center\">"+str(F4_net)+"</td><td align=\"center\">"+str(F4)+"</td></font></tr>\n")

f.write("<tr align=\"left\"><font style='font-family:arial;'><td style='background-color:#93c1f6;'>FG</td><td align=\"center\">"+str(FG_tp)+"</td><td align=\"center\">"+str(FG_pf)+"</td><td align=\"center\">"+str(FG_net)+"</td><td align=\"center\">"+str(FG)+"</td></font></tr>\n")

f.write("<tr align=\"left\" style='background-color:#fcdfff;'><b><font style='font-family:arial;'><td>Grand Total</td><td align=\"center\">"+str(total_tp)+"</td><td align=\"center\">"+str(total_pf)+"</td><td align=\"center\">"+str(total_net)+"</td><td align=\"center\">"+str(total_MR)+"</td></font></b></tr>\n")
...
f.write("<img src='data:image/png;base64,{0}'/ width='800' height='600'>".format(MR_Data2)+"</div>")
