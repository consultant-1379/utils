...
x=subprocess.Popen('ls | grep mediation', stdout=subprocess.PIPE, shell=True)
...
for folds in list:
	...
	for pkgs in list1:
		...
		n=len(groups)
        	...
        	os.system("curl -v -u esjkadm100:Naples\!0512 --upload-file "+pkgs+" https://arm104-eiffel004.lmera.ericsson.se:8443/nexus/content/repositories/releases/com/ericsson/eniq/stats/tp/"+folds+"/"+split_pkg[0]+"/"+split_pkg[1]+"/"+pkgs)
